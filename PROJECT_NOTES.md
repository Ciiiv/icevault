...
>
> **Completed June 2026:** maybePurgeSessions(db) call was missing from worker main handler -- 5% probabilistic global session purge now actually runs (was defined but never called). Orphaned OPENAI PROXY comment removed from worker (was misplaced above image proxy handler).
>
