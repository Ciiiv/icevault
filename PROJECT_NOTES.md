...
| 20 | eBay shipping -- replace hardcoded $1.00 with editable shipping cost field. Update options with hints: USPS Ground Advantage (bubble mailer, tracked, ~$5), USPS Priority Mail (bubble mailer/box, faster, ~$10), USPS First Class Top Loader (small envelope, tracked, ~$4), USPS First Class PWE (plain envelope, no tracking, ~$1), Free Shipping. Default Ground Advantage $5.00. Apply to single card tab and queue. SOAP codes: USPSGroundAdvantage, USPSPriority, USPSFirstClass | ⏯ Next |
...
| eBay SOAP ConditionDescriptors | Card condition for category 261328 uses ConditionDescriptors container not ItemSpecifics. ConditionID 4000=Ungraded, 2750=Graded. Descriptor ID 40001=Card Condition, values: 400010=Poor, 400011=Good, 400012=Very Good, 400013=Excellent, 400014=Near Mint or Better. Graded cards require Professional Grader (27501) and Grade (27502) descriptors |
...
>
> **Next priorities:** Item 20 (shipping price field + options), item 21 (eBay desc cost hint), item 15 (API keys modal polish), item 14 (duplicate detection -- future).
