...
- **eBay listing** -- submit cards directly to eBay from Ice Vault. Fixed Price or Auction, Best Offer, condition grading, AI-generated descriptions (Claude/GPT-4o/Gemini), picture from R2. Requires eBay Auth'n'Auth token from developer.ebay.com
